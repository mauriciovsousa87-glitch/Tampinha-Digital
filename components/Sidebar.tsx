...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setView, capabilities }) => {
  ...
  return (
    <aside className="w-20 md:w-64 bg-black border-r border-zinc-800 text-white flex flex-col transition-all duration-300">
      <div className="p-6 flex flex-col items-center md:items-start">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-full border border-yellow-500 flex flex-col items-center justify-center bg-black">
          ...
          <div className="hidden md:block">
            <h1 className="font-black text-xl leading-none text-yellow-500 uppercase tracking-tighter italic">SUPPLY</h1>
            <p className="text-[9px] text-white/50 font-bold tracking-widest uppercase">Nada nos para!</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-zinc-900">
        <div className="hidden md:block p-3 bg-zinc-900 rounded-xl text-[9px] text-zinc-600 uppercase font-black text-center">
